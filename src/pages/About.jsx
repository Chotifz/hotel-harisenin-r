            ...
            <div className="hero-content gap-16 flex-col lg:flex-row">
              ...
              <div className="ml-1 text-gray-300">
                ...
                <div className="max-w-md">
                  ...
                  <p className="mt-1">
                    Our vision is to be the top choice for travelers in
                    Indonesia, delivering five-star service and elevating
                    hospitality standards in the region. Our mission is to
                    provide unparalleled stay experiences by paying attention to
                    detail and fulfilling the needs of every guest.
                  </p>
                </div>
              </div>
            </div>
